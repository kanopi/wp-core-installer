...
class MuPluginScaffolder
{
    ...
    public function scaffold(): bool
    {
        ...
        if (!$this->isManaged()) {
            $this->io->write(
                '  - <comment>mu-plugin autoloader management disabled</comment>'
                . ' (manage-mu-plugin-autoloader = false).',
                true,
                IOInterface::VERBOSE
            );
        ...
        if ($this->isUserOwned($outputFile)) {
            $this->io->writeError(
                sprintf(
                    '  - <warning>WP Core Installer: %s exists and was not generated by this plugin;'
                    . ' leaving it untouched.</warning>'
    ...
    {
        return $this->paths->configString('mu-plugin-autoloader-file', self::DEFAULT_FILENAME);
    }
